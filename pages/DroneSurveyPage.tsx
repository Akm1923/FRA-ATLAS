        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-12">
            <div className="w-full md:w-1/2 lg:w-2/5">
                <img src="https://images.unsplash.com/photo-1621217737299-adf3b3543d04?q=80&w=1964&auto=format&fit=crop" alt="H35 Drone" className="rounded-xl shadow-2xl w-full" />
            </div>
